    ...
    <>
      <div id="scrollContainer" className="container-types flex md:flex-row flex-col w-full">
        ...
        <div className="types-title font-playfair text-primary py-1 flex flex-nowrap md:ml-32 ml- md:pt-20">
          <h1 className="text-9xl pr-3 pl-4 text-center font-medium">DIVE INhref JAMU</h1>
        </div>
        <Divider />
        <div className="flex md:flex-row flex-col">
          ...
          <a href={`/jamu/beras-kencur`} className="jamu-types text-primary">
            <div className="flex md:flex-col flex-col-reverse px-10 md:pt-20 pt-5 md:-mb-16 gap-12">
              ...
              <img data-aos="fade-up" data-aos-duration="1500" src={require("../assets/img/beras-kencur.png")} alt="" className="rounded-xl mb-0 md:min-w-[700px] min-w-full" />
            </div>
          </a>
          <Divider />
          ...
          <a href={`/jamu/jamu-kunyit`} className="jamu-types text-primary">
            <div className="flex flex-col px-10 md:-mt-24 gap-12">
              <img data-aos="fade-down" data-aos-duration="1500" src={require("../assets/img/ka-5.png")} alt="" className="rounded-xl mb-0 md:min-w-[700px] min-w-full" />
              <p className="font-neue font-normal text-justify md:text-2xl text-xl md:mt-10 md:mb-10 lg:w-3/4 w-full">
          ...
          <a href={`/jamu/jamu-temulawak`} className="jamu-types text-primary">
            <div className="flex md:flex-col flex-col-reverse px-10 md:pt-20 pt-5 md:-mb-12 gap-12">
              ...
              <img data-aos="fade-up" data-aos-duration="1500" src={require("../assets/img/te-5.png")} alt="" className="rounded-xl mb-0 md:min-w-[700px] min-w-full" />
            </div>
          </a>
          <Divider />

          {/* Jenis Jamu: Brohrefwali */}
          <a href={`/jamu/jamu-brontowali`} className="jamu-types text-primary">
            <div className="flex flex-col px-10 md:-mt-20 gap-12">
              <img data-aos="fade-down" data-aos-duration="1500" src={require("../assets/img/brontowali.png")} alt="" className="rounded-xl mb-0 md:min-w-[700px] min-w-full" />
              <p className="font-neue font-normal text-justify md:text-2xl text-xl md:mt-16 md:mb-10 lg:w-3/4 w-full">
                Rasakan manfaat brohrefwali untuk kesehatan ginjal dan menjaga keseimbangan tubuh.
              </p>
              <h1 data-aos="fade-up" data-aos-duration="1500" className="font-playfair text-6xl font-medium">BROhrefWALI</h1>
            </div>
          </a>
          <Divider />
          ...
          <a href={`/jamu/jamu-empon`} className="jamu-types text-primary">
            <div className="flex md:flex-col flex-col-reverse px-10 md:pt-20 pt-5 md:-mb-16 gap-12">
              ...
              <img data-aos="fade-up" data-aos-duration="1500" src={require("../assets/img/mp-4.png")} alt="" className="rounded-xl mb-0 md:min-w-[700px] min-w-full" />
            </div>
          </a>
          <Divider />
        </div>
