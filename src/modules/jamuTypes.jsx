...
const Divider = () => (
  ...
  return (
    <>
      ...
      <Sidebar />
        <div className="types-title font-playfair text-primary py-1 flex flex-nowrap md:ml-36 md:ml-32 ml- md:pt-20">
            <h1 className="text-9xl pr-3 pl-4 text-center font-medium">DIVE INTO JAMU</h1>
        </div>
        <Divider />
        <div className="flex md:flex-row flex-col w-fit">
          <a href="#" className="jamu-types text-primary">
              <div className="flex md:flex-col flex-col-reverse px-12 md:pt-20 pt-5 md:-mb-16 gap-12">
                  ...
                  <p className="font-neue font-normal text-justify md:text-2xl text-xl mb-16 mt-10 lg:w-3/4 w-full">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sapiente expedita quia animi doloremque? Ducimus, facilis.</p>
            ...
            <div className="flex flex-col px-12 md:-mt-64 gap-12">
                ...
                <p className="font-neue font-normal text-justify md:text-2xl text-xl md:mt-16 md:mb-10 lg:w-3/4 w-full">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sapiente expedita quia animi doloremque? Ducimus, facilis.</p>
                <h1 data-aos="fade-up" data-aos-duration="1500" className="font-playfair text-6xl font-medium">BERAS<br /> KENCUR</h1>
            </div>
            </a>
            <Divider />
            <a href="#" className="jamu-types text-primary">
