...
export const AboutGeneralJamus = () => {
  ...
  return (
    <div id="scrollContainer" className="mainContainer  ">
      <Sidebar />
      <div className="w-screen h-screen flex flex-col ml-32">
        <div className=" containerAtas jamu-img flex gap-3 flex-1" style={{ width: "110vw" }} >
          <div
        ...
        <div className="flex containerAtas h-1/3 gap-1" style={{ width: "200vw" }}>
          <div
            className="jamu-title w-full  sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl   font-playfair flex items-end translate-y-40 opacity-0"
            ref={(el) => {
              title = el;
            }}
          >
          ...
          <div className="desc flex w-1/2 flex-col justify-center items-center">
            <div className=" flex-1 flex items-end justify-center" style={{ width: "20vw" }}>
          ...
          <div
            className="jamu-title w-3/4 sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl    font-playfair flex items-end translate-y-40 opacity-0"
            ref={(el) => {
              title2 = el;
            }}
          >
          ...
          <div className="img w-3/4 flex items-end">
            <img src={require("../assets/img/jamus-4.png")} alt="" />
          </div>
        </div>
      </div>
      <div className=" flex h-1/2" style={{width:'100vw'}}>
        <div className=" jamuDesc-2 ml-32  flex flex-col items-center justify-center">
      ...
      <div className="w-screen h-screen flex flex-col">
        <div className="w-full flex flex-1">
          <div className="jamu-title w-1/2 p-32  sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl  font-playfair ">
            <h1>CONNECTING PEOPLES</h1>
          </div>
          <div className="w-1/2 flex justify-end">
            <img className="w-1/2 h-3/4" src={require('../assets/img/jamus-5.png')} alt="" />
          </div>
        </div>
